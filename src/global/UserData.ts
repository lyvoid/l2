class UserData {
	...
	public initial(): void {
		...
		let curUserTeam = [];
		curUserTeam.push({ charId: 2, row: CRType.up, col: CCType.front, level: 1 });
		curUserTeam.push({ charId: 2, row: CRType.down, col: CCType.front, level: 1 });
		curUserTeam.push({ charId: 2, row: CRType.mid, col: CCType.mid, level: 1 });
		curUserTeam.push({ charId: 2, row: CRType.up, col: CCType.back, level: 1 });
		curUserTeam.push({ charId: 2, row: CRType.down, col: CCType.back, level: 1 });
